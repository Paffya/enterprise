        ...
        <Container className="popupBack">
          <Row>
            <Col  md={5} className="mb-3 laptopmImgback">
              ...
              <img className="DesktopResponsive mt-3" style={{width:"100%" ,objectFit:"cover", borderRadius:"10px"}} src={silverLaptop } alt="" />
                ...
                <div className="dropdownLeader1">
                  <div className="d-flex justify-content-evenly">
                      ...
                      >
                        ...
                        >
                          ...
                          <div style={{ width: "61%" }} className="paraMob">
                            ...
                            >
                             <a className="text-black hoverHead" href={`/${post.cat_slug}/${post.post_name}`}> {post.post_title}</a>
                            </h5>
                            <div className="DesktopResponsive ">
                    ...
                    <div>
                      ...
                      <a href="/topic/featured" className="text-black ended mx-4">
                        See more
                      </a>
                    </div>
                  </div>
                ...
                <div className="dropdownLeader2">
                  <div className="d-flex justify-content-evenly">
                    <div className="borderR">
                      ...
                      <a href="/topic/podcasts" className="text-black ended mx-4">
                        See more
                      </a>
                    </div>
                    ...
                    <div className="borderR">
                      ...
                      <a href="/topic/interview" className="text-black ended mx-4">
                        See more
                      </a>
                    </div>
                    ...
                    <div>
                      ...
                      <a href="/topic/guest-author" className="text-black ended mx-4">
                        See more
                      </a>
                    </div>
                  </div>
