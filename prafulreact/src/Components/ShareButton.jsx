...
const ShareButtons = ({ shareText, shareUrl }) => {
  ...
  return (
    <div className=''>
      ...
      <button className='mx-1  share-btn' >
      <img src={shareIcon} alt="share" style={{width:"25px", padding:"1px"}} />
      </button>
        
      <button className='mx-1 bg-black btn-share' title='Share on Facebook' onClick={() => openSharePopup(facebookShareUrl)}>
      ...
      <button className='mx-1 bg-black btn-share' title='Share on Twitter' onClick={() => openSharePopup(twitterShareUrl)}>
