      ...
      <urlset {...namespaceAttrs}>
        {reports.map(report => (
          <ul key={report.id} className='mt-3'>
            <url>
              <li style={{fontSize:"13px", listStyleType:"none", fontWeight:"500" }}> <a href={`${base_url + 'tag' + "/" + report.subcat_slug}`} className='text-black'>{base_url + 'tag' + "/" + report.subcat_slug}</a></li>
            </url>
