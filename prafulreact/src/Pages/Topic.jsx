...
const [accordionOpen, setAccordionOpen] = useState(false);
  ...
  return (
   ...
   <HelmetProvider>
        ...
        <meta name="twitter:title" content={postData[0].post_title} />
        <meta name="twitter:description" content={postData[0].meta_description} />
        <meta name="twitter:image" content={`${webPath}${postData[0].banner_img}`} />
